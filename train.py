...
if __name__ == "__main__":
    ...
    parser.add_argument("--gen_path", type=str, default='./checkpoints/CTGAN-Sen2_MTC/G_epoch7_PSNR21.259.pth', help="path to the model of generator")
    parser.add_argument("--dis_path", type=str, default='./checkpoints/CTGAN-Sen2_MTC/D_epoch7_PSNR21.259.pth', help="path to the model of discriminator")
    ...
    parser.add_argument("--train_path", type=str, default='../../../dataset/multi_temporal_Sentinel2/train.txt', help="path to train.txt")
    parser.add_argument("--val_path", type=str, default='../../../dataset/multi_temporal_Sentinel2/val.txt', help="path to val.txt")
    parser.add_argument("--dataset_path", type=str, default='../../../dataset/multi_temporal_Sentinel2/Sen2_MTC', help="path to image folder")
    ...
    parser.add_argument("--dataset_name", type=str, default='Sen2_MTC_CTGAN', help="name of the dataset")
